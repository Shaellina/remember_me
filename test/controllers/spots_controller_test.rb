...
class SpotsControllerTest < ActionController::TestCase
  ...
  test "should create spot" do
    assert_difference('Spot.count') do
      post :create, spot: { day_id: @spot.day_id, destination: @spot.destination, end: @spot.end, name: @spot.name, start: @spot.start }
    end
  ...
  test "should update spot" do
    patch :update, id: @spot, spot: { day_id: @spot.day_id, destination: @spot.destination, end: @spot.end, name: @spot.name, start: @spot.start }
    assert_redirected_to spot_path(assigns(:spot))
  end
